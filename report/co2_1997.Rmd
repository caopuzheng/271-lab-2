...
```{r polynomial-forecast, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width="60%", fig.cap="Linear model with polynomial trend and dummy seasonality forecast"}
