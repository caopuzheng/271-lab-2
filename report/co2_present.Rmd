...
co2_present_raw <- read.csv("C:\\Users\\lisaw\\Desktop\\MIDS_class\\w271\\Lab_2\\271_team_lab_2\\report\\co2_present_raw.csv")
...
#In case the above website is down, we downloaded the dataset 
co2_present_month <- read.csv("C:\\Users\\lisaw\\Desktop\\MIDS_class\\w271\\Lab_2\\271_team_lab_2\\report\\co2_present_month.csv")
...
While the 1997 ARIMA model outperformed the linear models, it still under-predicted actual $CO_2$ levels after 2005. We decided to refit this model using the actuals to capture the accelerated $CO_2$ increase.
